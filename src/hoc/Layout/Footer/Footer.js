					...
					<Grid.Row>
						<Grid.Column width={4}>
							...
							<List link inverted>
								...
								<ListItem path="/get-involved">Get Involved</ListItem>
							</List>
						</Grid.Column>
						<Grid.Column width={4}>
							...
							<List link inverted>
								...
								<ListItem path="/faq#contactUs">Contact Us</ListItem>
							</List>
						</Grid.Column>
						<Grid.Column width={5}>
							{/* <Form>
							...
							<Icon
								...
								className="fb-icon"
								onClick={() =>
									window.open('https://www.facebook.com/SKCmutualaid', '_blank')
								}
							/>{' '}
							<Icon
								name="instagram"
							...
							<Icon
								...
								className="pt-icon"
								onClick={() =>
									window.open('https://www.patreon.com/skcemutualaid', '_blank')
								}
							/>
							<br />
							<br />
