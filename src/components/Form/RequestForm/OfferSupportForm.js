...
const validationSchema = Yup.object({
	...
	walk_distance: Yup.string().max(200, 'Please enter less than 200 characters'),
	...
	extra_info: Yup.string().max(1000, 'Please enter less than 1000 characters'),
					...
					<Form>
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Input
								...
								tip={
									<p>
										Feel free to include notes like &quot;I use a bike&quot; or
										&quot;I want to buddy up with someone who has a car.&quot;
									</p>
								}
						...
						<Card>
							<Card.Text style={{ fontWeight: 'bold', padding: '20px' }}>
								If you answered &quot;coordinating requests for support&quot;
								(contacting community members regarding their request for
								support and coordinating that) in the above question, please
								answer the question below. If not, go to the next
								question.&quot;
							</Card.Text>
						</Card>
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Checkboxes
								...
								tip={
									<div>
										<strong>
											For coordinating requests, we are looking for volunteers
											who can:
										</strong>

										<ul>
											<li>
												1. Commit at least 6 hours per week for the first few
												weeks and then 2 hours or more after for at least three
												months
											</li>
											<li>
												2. Must have an understanding of transformative justice,
												abolition, emotional first aid, solidarity support, or
												take these necessary training that we share with you in
												the first couple of weeks of volunteering,
											</li>
											<li>
												3. Attend weekly meetings and be committed to continued
