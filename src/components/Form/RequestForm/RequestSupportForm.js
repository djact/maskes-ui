...
const validationSchema = Yup.object({
	...
	items_list: Yup.string()
		.required('Required')
		.max(2000, 'Please enter less than 2000 characters'),
	food_restrictions: Yup.string()
		.required('Required')
		.max(200, 'Please enter less than 200 characters'),
	household_number: Yup.number('Please input a number')
		.required('Required')
		.max(99, 'Please enter less than 2 digits')
		.min(1, 'Household size is at least 1'),
	urgency: Yup.string().required('Required'),
	financial_support: Yup.string().required('Required'),
	special_info: Yup.string()
		.required('Required')
		.max(2000, 'Please enter less than 2000 characters'),
				...
				{({ isValid, isSubmitting, handleChange }) => (
					<Form>
							...
							<Select
								...
								description={
									<p>
										...
										<br />
										{"If you're in Seattle, please complete this:"}
										<a
											href="https://docs.google.com/forms/d/1rOkXW6ElVT0MH9oSI-TuW8L5szCt-ULbZhWebARRZNI/viewform"
											target="_blank"
						...
						<Card className="mt-3 mb-3" style={{ padding: '20px' }}>
							...
							/>
							<Row>
								<Input label="City" asCol name="city" required />
								<Input
									label="Zip"
									asCol
									name="zip_code"
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Radios
								...
								tip={
									<div>
										<p>
											If you say <strong>YES</strong>, it will be will be faster
											and simpler to get you your delivery!{' '}
										</p>
										<p>
											If you say <strong>NO</strong>{' '}
											{
												"and you live outside of our range, we will let you know that we can't help you and tell you where to go to find help for your location, which may take a while, and then you will have to fill out another group's form and begin the whole process again from scratch."
											}{' '}
											(We will never share your information with advertisers,
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<TextArea
								...
								tip={
									<p>{`Items can be general like "milk," or specific like "a 24-pack of the purple Always brand overnight menstrual pads with wings."`}</p>
								}
								description={
									<p>
										We are on a volunteer basis and actively fundraising. At
										this moment we are set up to prioritize delivering ONLY
										ESSENTIAL/URGENT/ IMMEDIATE needs of our community members.
										<br />
										We will do our best to match your requests, but if we can
										not find something specific we may get you a similar
										substitute. We trust you to know your needs and we are
										committed to delivery without judgement.
									</p>
								}
								name="items_list"
								required
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<TextArea
								...
								placeholder="Your Answer"
								description={
									<p>If there are no allergies/ restrictions, enter none.</p>
								}
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Radios
								...
								description={
									<p>Please allow us 48 hours to respond to your request.</p>
								}
								name="urgency"
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Radios
								...
								description={
									<p>
										We can fund supplies up to a certain amount per request
										(While funding lasts) for folks who are quarantined without
										pay, sick, disabled, elderly, undocumented, queer, Black,
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<TextArea
								...
								description={
									<p>
										Any support or resources you would like to offer, questions,
										comments, concerns.
									</p>
								}
								placeholder="Your Answer"
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
							<Radios
								...
								description={
									<p>
										If you need assistance in setting up your own mutual aid pod
										to support yourself and your neighbors with current/ future
										needs? If so, please go this link to join our Neighborhood
						...
						<Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            ...
                            can offer?"
								description={
									<p>
										In the near future, we are considering expanding the types
										of mutual aid we offer. These might include emotional
										support, household chore assistance, childcare, dog walking,
										etc. Please note access details when possible, like: are you
										able to be scent-free (
										<a
											href="http://thinkbeforeyoustink.com/howtogofragrancefree.html"
											target="_blank"
											rel="noopener noreferrer"
										>
											How to go fragrance free
										</a>
										)? Can you speak several languages, or sign languages? Do
										you have a wheelchair accessible van?
									</p>
								}
								placeholder="Your Answer"
						...
						<Card className="mt-3 mb-3" style={{ padding: '20px' }}>
							<Card.Text>
								We know that violence and abuse thrives in isolation, so do keep
								reaching out to your friends and family and creating online
								spaces to connect. If you or your loved ones need more resources
								and support, reach out to any of these organizations:
							</Card.Text>
							<ul>
								<li>
									<a
								...
								<li>
									<a
										...
										rel="noopener noreferrer"
									>
										The Northwest Network of Bi, Trans, Lesbian, and Gay
										Survivors of Abuse
									</a>
								</li>
								<li>
									<a
										href="https://arcofkingcounty.org/"
										target="_blank"
										rel="noopener noreferrer"
									>
								...
								<li>
									<a
										href="https://www.mapsredmond.org/amen/"
										target="_blank"
										rel="noopener noreferrer"
									>
										MAPS AMEN
						...
						<Button
							...
							className="mt-3 mr-2 submit-request-button"
						>
