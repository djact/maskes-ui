	...
	return (
		<Aux>
			<Form.Group controlId="formBasicEmail">
				...
				{error &&
					email_error_messages.map((msg, idx) => (
			...
			<Form.Group controlId="formBasicPassword">
				...
				{error &&
					password_error_messages.map((msg, idx) => (
						<Alert key={idx} variant="danger">
							{msg}
						</Alert>
					))}
...
export const RegisterForm = (props) => {
	...
	if (error && error.response) {
		if (error.response.data && error.response.data.first_name) {
			first_name_error_messages = [
				...first_name_error_messages,
				error.response.data.first_name
			];
		}
		if (error.response.data && error.response.data.last_name) {
	...
	return (
		<Aux>
			<Form.Group controlId="formBasicFirstName">
				...
				{error &&
					first_name_error_messages.map((msg, idx) => (
						<Alert key={idx} variant="danger">
							{msg}
						</Alert>
					))}
			...
			<Form.Group controlId="formBasicLastName">
				...
				{error &&
					last_name_error_messages.map((msg, idx) => (
						<Alert key={idx} variant="danger">
							{msg}
						</Alert>
					))}
