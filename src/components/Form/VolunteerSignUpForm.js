			...
			>
				{({ isValid, isSubmitting }) => (
					<FormikForm className="signup-form">
						<Row>
							<Col>
								<Input
									...
									tip={
										<>
											First name and Last name can be set private after your
											account is created.
										</>
									}
									name="first_name"
							...
							<Col>
								<Input
									...
									tip={
										<>
											If you are not comfortable listing your full name, enter
											Initial/ few letters of your last name.
										</>
									}
									name="last_name"
						...
						<Input
							label="Password"
							tip={<>Your password must be at least 6 characters.</>}
							name="password"
							type="password"
