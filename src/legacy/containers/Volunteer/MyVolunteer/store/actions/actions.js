    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Your volunteer #${volunteerId} has been canceled, the corresponding request will be available for all volunteers`,
                        'warning'
                    )
                )
            })
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        `Failed to cancel volunteer #${volunteerId} data from server`,
                        'danger'
                    )
                )
            })
    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Successfully confirmed delivery for request #${requestId}.`,
                        'success'
                    )
                )
                dispatch(
                    setAlert(
                        'Please fill out reimbursement form if needed.',
                        'info'
                    )
                )
            })
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        `Failed to update delivery status for request #${requestId}`,
                        'danger'
                    )
                )
            })
