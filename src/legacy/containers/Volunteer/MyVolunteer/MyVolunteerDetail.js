                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                onClick={() =>
                                    history.push(
                                        `/volunteer/${volunteer.request_detail.id}`
                                    )
                                }
                            >
                                {volunteer.request_detail.id}
                            </td>
                        </tr>
                        <tr>
                            <td>Request Date</td>
                            <td>
                                {new Date(
                                    volunteer.request_detail.created_date
                                ).toLocaleDateString()}
                            </td>
                        </tr>
                        <tr>
                            <td>Location</td>
                            <td>{volunteer.request_detail.locations}</td>
                        </tr>
                        <tr>
                            <td>List of Items</td>
                            <td style={{ width: '80%' }}>
                                {volunteer.request_detail.items_list}
                            </td>
                        </tr>
                        <tr>
                            <td>Food Restrictions</td>
                            <td>
                                {volunteer.request_detail.food_restrictions}
                            </td>
                        </tr>
                        <tr>
                            <td>Household Size</td>
                            <td>{volunteer.request_detail.household_number}</td>
                        </tr>
                        <tr>
                            <td>Urgency</td>
                            <td>{volunteer.request_detail.urgency}</td>
                        </tr>
                        <tr>
                        ...
                        <Aux>
                            ...
                            <Table size="sm" responsive="sm">
                                <tbody>
                                    <tr>
                                        <td>Name</td>
                                        <td>
                                            {volunteer.request_detail.requester}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Contact Phone</td>
                                        <td>
                                            {volunteer.request_detail.phone}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Delivery Address</td>
                                        <td>{`${volunteer.request_detail.address1} ${volunteer.request_detail.address2}, ${volunteer.request_detail.city}, WA ${volunteer.request_detail.zip_code}`}</td>
                                    </tr>
                                    <tr>
                                        <td>Budget</td>
                                        <td
                            ...
                            <div>
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        showDeleteModalHandler(volunteer.id)
                                    }
                                >
                                    Cancel
                                </Button>
                    ...
                    (volunteer.status === 'Delivered' && (
                        <Reimbursement
                            ...
                            reimbursement_detail={
                                volunteer.reimbursement_detail
                            }
    ...
    return (
        ...
        >
            <DeleteModal
                ...
                deleteHandler={volunteerDeleteHandler}
                label="Volunteer"
            />
            <UpdateModal
                showUpdateModal={showUpdateModal}
                closeModalHandler={closeUpdateModalHandler}
                updateHanlder={confirmDeliveredHandler}
            />
            <Container fluid>
