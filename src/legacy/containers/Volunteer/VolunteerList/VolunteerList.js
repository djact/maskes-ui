...
const VolunteerList = (props) => {
    const { requests, loading, name, match, fetchVolunteerRequests } = props
            ...
            <Card key={index} className="card_shadow">
                <Accordion>
                    <Accordion.Toggle
                        as={Card.Header}
                        eventKey="1"
                        className="request_accordion"
                    >
                        <Card.Title>Request #{request.id}</Card.Title>
                        <small
                            style={{
                                color:
                                    request.urgency === 'In the next 72 hours'
                                        ? '#d9534f'
                                        : '#0275d8',
                                fontSize: '13px',
                            }}
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            Family size: {request.household_number}
                        </Card.Text>
...
export default connect(mapStateToProps, { fetchVolunteerRequests })(
    VolunteerList
)
