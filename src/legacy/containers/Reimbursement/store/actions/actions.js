    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Your reimbursement #${reimbursementId} has been canceled`,
                        'warning'
                    )
                )
            })
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        `Failed to cancel reimbursement #${reimbursementId}`,
                        'danger'
                    )
                )
            })
    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Reimbursement #${reimbursementId} updated.`,
                        'success'
                    )
                )
            })
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        `Failed to update reimbursement #${reimbursementId}`,
                        'danger'
                    )
                )
            })
    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Successfully create reimbursement #${reimbursementId}.`,
                        'success'
                    )
                )
...
export const skipReimbursement = (
    skip_reimbursement,
    volunteerId,
    requestId
) => {
