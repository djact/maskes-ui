...
const Reimbursement = (props) => {
    ...
    return !skip ? (
        <div>
            ...
            {(!reimbursement ? createReimbursement : true) ? (
                display
            ) : (
                <Button
                    className="create-reimbursement-button"
                    onClick={() => setCreateReimbursement(true)}
                >
        ...
        <div className="thank-you-note">
            <h5 className="thank-you-note-header">
                Thank you for your support {supporter_name}!
            </h5>
            <p>
                Because of your generous donation, we will be able to help
                families overcome their hardship during COVID-19.
            </p>
            <p>
                We will send you updates over the next few months so that you
                know exactly what is happening with your donation, and the
                impact that we have been able to create together.
            </p>
