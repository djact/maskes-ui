        ...
        request_detail = (
            <tbody>
                ...
                <tr>
                    ...
                    <td
                        style={{
                            color: requestStatus.request_status_style[
                                request.status
                            ],
                        }}
                    >
                ...
                <tr>
                    <td>Address</td>
                    <td>{`${request.address1} ${request.address2}, ${request.city}, WA ${request.zip_code}`}</td>
                </tr>
                <tr>
                    <td>Locations</td>
                ...
                <tr>
                    ...
                    <td>{request.contact_preference}</td>
                </tr>
                <tr>
                    <td>Prefered Foods</td>
                    <td>{request.prefered_food}</td>
                </tr>
                <tr>
                    <td>List of Items</td>
                ...
                <tr>
                    ...
                    <td>{request.financial_support}</td>
                </tr>
                <tr>
                    <td>Special Info</td>
                    <td>{request.special_info}</td>
                </tr>
                <tr>
                    <td>Share Info with Volunteer</td>
                    <td>{request.share_info ? 'Yes' : 'No'}</td>
                </tr>
                <tr>
                    <td>Checkin</td>
                    <td>{request.need_checkin}</td>
                </tr>
                <tr>
                    <td>Extra Info</td>
                    <td>{request.extra_info}</td>
                </tr>
                <tr>
                    <td>Mutual Aid Pod</td>
                    <td>{request.ma_pod_setup ? 'Yes' : 'No'}</td>
                </tr>
                <tr>
                    <td>Resources Offer</td>
                    <td>{request.offer_resources}</td>
                </tr>
            </tbody>
        )
    }
    ...
    return (
        <Requests name={name}>
            <DeleteModal
                ...
                deleteHandler={requestDeleteHandler}
                label="Request"
            />
            {onEdit ? (
                            ...
                            {request.status === requestStatus.NEW ? (
                                <div>
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        onClick={() =>
                                            showDeleteModalHandler(request.id)
                                        }
                                    >
                                        Delete
                                    </Button>
