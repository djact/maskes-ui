    ...
    return (dispatch) => {
        ...
        return axios
            ...
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        'Failed to fetch donation data from server',
                        'danger'
                    )
                )
            })
    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(
                    setAlert(
                        `Your donation #${donationId} has been canceled`,
                        'warning'
                    )
                )
            })
            .catch((error) => {
                ...
                dispatch(
                    setAlert(
                        `Failed to cancel donation #${donationId}`,
                        'danger'
                    )
                )
            })
    ...
    return (dispatch) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                dispatch(fetchDonation(requestId))
                dispatch(
                    setAlert(`Donation #${donationId} updated.`, 'success')
                )
            })
            .catch((error) => {
