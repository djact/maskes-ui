...
const DonationForm = (props) => {
    ...
    return (
        <Form onSubmit={handleClick} className="my-3">
            ...
            <p>
                Please enter the amount you would like to donate and click on
                Checkout button. Then you will be redirect to checkout page via
                Square. If you have any question please contact our admins via{' '}
                <a href="mailto: skcemutualaid@gmail.com">
                    skcemutualaid@gmail.com
                </a>
            </p>
