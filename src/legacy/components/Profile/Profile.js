...
const Profile = (props) => {
    const { profile, myId, nameChangeSubmitHandler, updateProfileHandler } =
        props
    ...
    const profile_edit_form = (id, key) =>
        isOwner && (
            <Col sm={6} md="auto">
                <Form
                    inline
                    onSubmit={(e) => updateProfileHandler(e, profileData)}
                >
                    <Form.Control
                        id={id}
                            ...
                            <div className="d-flex flex-column align-items-center text-center">
                                ...
                                <div className="mt-3">
                                    <h4>
                                        ...
                                        {!showEditDisplayName &&
                                            edit_button(toggleEditDisplayName)}
                                    </h4>

                                    {profileData[2].onEdit ||
                                    profile.bio === '' ? (
