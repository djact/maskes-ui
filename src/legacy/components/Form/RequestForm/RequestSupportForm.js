...
const RequestSupportForm = (props) => {
    ...
    const { createRequest, updateRequest, onEdit, setOnEdit, requestData } =
        props
                    ...
                    <Form>
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            <Radios
                                ...
                                tip={
                                    <div>
                                        <p>
                                            If you say <strong>YES</strong>, it
                                            will be will be faster and simpler
                                            to get you your delivery!{' '}
                                        </p>
                                        <p>
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            <TextArea
                                ...
                                description={
                                    <p>
                                        We are on a volunteer basis and actively
                                        fundraising. At this moment we are set
                                        up to prioritize delivering ONLY
                                        ESSENTIAL/URGENT/ IMMEDIATE needs of our
                                        community members.
                                        <br />
                                        We will do our best to match your
                                        requests, but if we can not find
                                        something specific we may get you a
                                        similar substitute. We trust you to know
                                        your needs and we are committed to
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            <TextArea
                                ...
                                description={
                                    <p>
                                        If there are no allergies/ restrictions,
                                        enter none.
                                    </p>
                                }
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            <Radios
                                ...
                                description={
                                    <p>
                                        Please allow us 48 hours to respond to
                                        your request.
                                    </p>
                                }
                                name="urgency"
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            <Radios
                                ...
                                description={
                                    <p>
                                        We can fund supplies up to a certain
                                        amount per request (While funding lasts)
                                        for folks who are quarantined without
                                        pay, sick, disabled, elderly,
                                        undocumented, queer, Black, Indigenous,
                        ...
                        <Card className="mt-3 mb-3 px-4 pb-2 pt-3">
                            ...
                            can offer?"
                                description={
                                    <p>
                                        In the near future, we are considering
                                        expanding the types of mutual aid we
                                        offer. These might include emotional
                                        support, household chore assistance,
                                        childcare, dog walking, etc. Please note
                                        access details when possible, like: are
                                        you able to be scent-free (
                                        <a
                                        ...
                                        )? Can you speak several languages, or
                                        sign languages? Do you have a wheelchair
                                        accessible van?
                                    </p>
                                }
                                placeholder="Your Answer"
                        ...
                        <Card className="mt-3 mb-3" style={{ padding: '20px' }}>
                            <Card.Text>
                                We know that violence and abuse thrives in
                                isolation, so do keep reaching out to your
                                friends and family and creating online spaces to
                                connect. If you or your loved ones need more
                                resources and support, reach out to any of these
                                organizations:
                            </Card.Text>
                            <ul>
                                <li>
