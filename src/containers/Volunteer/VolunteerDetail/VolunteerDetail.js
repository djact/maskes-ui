		...
		display = (
			<Aux>
					...
					<tbody>
						...
						<tr>
							...
							<td style={{ fontWeight: 'bold', color: 'green' }}>
								${75 + 25 * (parseInt(request.household_number) - 1)}
							</td>
						</tr>
				...
				<Donation
					...
					reimbursementStatus={
						request.reimbursement && request.reimbursement.reimbursement_status
					}
					reimbursementAmount={
						request.reimbursement && request.reimbursement.reimbursement_amount
					}
					onDonate={onDonate}
