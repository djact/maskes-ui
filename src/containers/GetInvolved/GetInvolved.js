		...
		<React.Fragment>
			<Container className="p-3">
				...
				>
					...
					donate to particular grocery deliveries. You do not need to use your
					own money to buy groceries, as our collective will reimburse you
				</ListRow>
			</Container>
			<SignUp />
		</React.Fragment>
...
const GetInvolvedPage = () => (
	<GetLayout pageTitle="Get Involved">
		...
		>
			We want to build towards a future of care and safety with you! To get
			involved as a supporter, please fill out our “Offer Support” form! \n Once
			you fill out our form, you will be able to support our essential item and
			grocery delivery program. You can sign up to be a shopper, or donate to
			particular grocery deliveries. You do not need to use your own money to
			buy groceries, as our collective will reimburse you
		</ListRow>
		...
		>
			We looking for volunteers who would be able to offer skills in researching
			resources, collecting supplies, emotional support, social media, volunteer
			coordination, coordinating requests for support
		</ListRow>
		...
		<ListRow
			...
			pathName="/get-involved"
			icon={<FaCommentDollar style={{ fontSize: '5rem', color: '#f7b015' }} />}
		>
			We are completely community funded! Can you make recurring donations to us
			on our Patreon? Please share our Patreon with your family, friends and
